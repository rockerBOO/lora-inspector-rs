	...
	return (
		((a, b, c) => {
			(c.namespaces = {
				...
				(c.noop = (a) => a),
				(c.alphaNumerate = (a) => String.fromCharCode(97 + (a % 26))),
				(c.extend = (a) => {
					var b, d, e;
				...
				(c.replaceAll = (a, b, c) => a.replace(new RegExp(b, "g"), c)),
				(c.ensureUnit = (a, b) => ("number" == typeof a && (a += b), a)),
				(c.quantity = (a) => {
					if ("string" == typeof a) {
						var b = /^(\d+)\s*(.*)$/g.exec(a);
				...
				(c.querySelector = (a) => (a instanceof Node ? a : b.querySelector(a))),
				(c.times = (a) => Array.apply(null, new Array(a))),
				(c.sum = (a, b) => a + (b ? b : 0)),
				(c.mapMultiply = (a) => (b) => b * a),
				(c.mapAdd = (a) => (b) => b + a),
				(c.serialMap = (a, b) => {
					var d = [],
						e = Math.max.apply(
				...
				(c.serialize = (a) =>
					null === a || void 0 === a
						...
						: ("number" == typeof a
							...
							Object.keys(c.escapingMap).reduce(
								(a, b) => c.replaceAll(a, b, c.escapingMap[b]),
								a,
							))),
				(c.deserialize = (a) => {
					if ("string" != typeof a) return a;
					a = Object.keys(c.escapingMap).reduce(
						(a, b) => c.replaceAll(a, c.escapingMap[b], b),
						a,
					);
					try {
				...
				(c.createSvg = (a, b, d, e) => {
					...
					return (
						...
						Array.prototype.slice
							...
							.filter((a) => a.getAttributeNS(c.namespaces.xmlns, "ct"))
							.forEach((b) => {
								a.removeChild(b);
							}),
				...
				(c.normalizeData = (a, b, d) => {
					...
					return (
						...
						(e = f.normalized.series.every((a) => a instanceof Array)
							? Math.max.apply(
									null,
				...
				(c.safeHasProperty = (a, b) =>
					null !== a && "object" == typeof a && a.hasOwnProperty(b)),
				(c.isDataHoleValue = (a) =>
				...
				(c.orderOfMagnitude = (a) =>
					Math.floor(Math.log(Math.abs(a)) / Math.LN10)),
				(c.projectLength = (a, b, c) => (b / c.range) * a),
				(c.getAvailableHeight = (a, b) =>
					Math.max(
				...
				(c.isNumeric = (a) => null !== a && isFinite(a)),
				(c.isFalseyButZero = (a) => !a && 0 !== a),
				(c.getNumberOrUndefined = (a) => (c.isNumeric(a) ? +a : void 0)),
				(c.isMultiValue = (a) =>
				...
				(c.getBounds = (a, b, d, e) => {
					...
					for (
						...
						h = f(h, k.step);
					while (i - k.step >= k.high) i = f(i, -k.step);
				...
				(c.createGridBackground = (a, b, c, d) => {
					var e = a.elem(
						"rect",
				...
				(c.createLabel = (a, d, e, f, g, h, i, j, k, l, m) => {
					var n,
						o = {};
					if (
				...
				(c.optionsProvider = (b, d, e) => {
					...
					return (
						f(),
						{
							...
							getCurrentOptions: () => c.extend({}, h),
						}
					);
				}),
				(c.splitIntoSegments = (a, b, d) => {
		...
		((a, b, c) => {
			(c.Interpolation = {}),
				...
				(c.Interpolation.monotoneCubic = (a) => {
					var b = { fillHoles: !1 };
					return (
						(a = c.extend({}, b, a)),
						function d(b, e) {
		...
		((a, b, c) => {
			...
			function e(a, b) {
				a.forEach((c, d) => {
					u[c.command.toLowerCase()].forEach((e, f) => {
						b(c, e, d, f, a);
					});
				});
			}
			...
			function d(a) {
				...
				a.distributeSeries
					? ((b = c.normalizeData(
						...
						(b.normalized.series = b.normalized.series.map((a) => [a])))
					: (b = c.normalizeData(
							this.data,
							a.reverseData,
							a.horizontalBars ? "x" : "y",
				...
				if (a.stackBars && 0 !== b.normalized.series.length) {
					var i = c.serialMap(b.normalized.series, () =>
						Array.prototype.slice
							.call(arguments)
							.map((a) => a)
							.reduce(
				...
				var n = { x: e.x1 + e.width() / 2, y: e.y2 + e.height() / 2 },
					o =
						...
						j.raw.series.filter((a) =>
							a.hasOwnProperty("value") ? 0 !== a.value : 0 !== a,
						).length;
