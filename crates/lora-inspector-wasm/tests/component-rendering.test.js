...
test("moduleBlocks parsing functions", (t) => {
	...
	t.is(typeof moduleBlocks.parseSDKey, "function", "parseSDKey should be a function");
	...
	t.is(typeof moduleBlocks.NUM_OF_BLOCKS, "number", "NUM_OF_BLOCKS should be a number");
});
...
test("exercise moduleBlocks parsing functionality", (t) => {
	...
	for (const key of testKeys) {
		...
		t.truthy(result !== undefined, `parseSDKey should handle ${key} gracefully`);
	}
});
