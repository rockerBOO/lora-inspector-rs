...
describe("Dataset Components", () => {
	describe("Dataset Component", () => {
		it("should handle empty datasets gracefully", async () => {
			const { Dataset } = await import("../assets/js/components/dataset/Dataset.jsx");
		...
		it("should handle invalid JSON in datasets gracefully", async () => {
			...
			const invalidJsonMetadata = new Map([
				["ss_datasets", "invalid json"]
			]);
	...
	describe("CaptionDropout Component", () => {
		it("should display caption dropout settings", async () => {
			const { CaptionDropout } = await import("../assets/js/components/dataset/CaptionDropout.jsx");
	...
	describe("TagFrequency Component", () => {
		it("should display tag frequency data", async () => {
			const { TagFrequency } = await import("../assets/js/components/dataset/TagFrequency.jsx");
		...
		it("should handle empty tag frequency", async () => {
			...
			expect(() => render(<TagFrequency tagFrequency={emptyTagFrequency} />)).not.toThrow();
		});
	});
});
...
describe("Analysis Components", () => {
	describe("StatisticRow Component", () => {
		it("should render statistic rows correctly", async () => {
			const { StatisticRow } = await import("../assets/js/components/analysis/StatisticRow.jsx");
			...
			render(<table><tbody><StatisticRow {...mockProps} /></tbody></table>);
		...
		it("should handle missing statistical values", async () => {
			...
			expect(() => render(<table><tbody><StatisticRow {...minimalProps} /></tbody></table>)).not.toThrow();
		});
	});

	describe("Precision Component", () => {
		it("should render without crashing", async () => {
			const { Precision } = await import("../assets/js/components/analysis/Precision.jsx");
			
			const mockWorker = createMockWorker();
			
			// This component requires worker interaction, so we just test it doesn't crash
			expect(() => render(<Precision filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
	});

	describe("Weight Component", () => {
		it("should handle weight display", async () => {
			const { Weight } = await import("../assets/js/components/analysis/Weight.jsx");
...
describe("Blocks Component", () => {
	it("should render without crashing when no block weights are supported", async () => {
		const { Blocks } = await import("../assets/js/components/analysis/Blocks.jsx");
		
		const mockWorker = createMockWorker();
		
		expect(() => render(<Blocks filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
	});
...
describe("Interactive Analysis Components", () => {
	describe("BaseNames Component", () => {
		it("should render when base names are available", async () => {
			const { BaseNames } = await import("../assets/js/components/analysis/BaseNames.jsx");
	...
	describe("UnetKeys Component", () => {
		it("should render UNet keys when available", async () => {
			const { UnetKeys } = await import("../assets/js/components/analysis/UnetKeys.jsx");
	...
	describe("TextEncoderKeys Component", () => {
		it("should render text encoder keys", async () => {
			const { TextEncoderKeys } = await import("../assets/js/components/analysis/TextEncoderKeys.jsx");
