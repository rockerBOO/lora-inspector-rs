...
describe("Network Components", () => {
	describe("LoRANetwork Component", () => {
		it("should render network structure correctly", async () => {
			const { LoRANetwork } = await import("../assets/js/components/network/LoRANetwork.jsx");
			...
			render(<LoRANetwork metadata={loraMetadata} filename="test.safetensors" worker={mockWorker} />);
		...
		it("should handle missing network rank gracefully", async () => {
			...
			expect(() => render(<LoRANetwork metadata={incompleteMetadata} filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
	});

	describe("LoKrNetwork Component", () => {
		it("should render LoKr network structure", async () => {
			const { LoKrNetwork } = await import("../assets/js/components/network/LoKrNetwork.jsx");
			...
			render(<LoKrNetwork metadata={lokrMetadata} filename="test.safetensors" worker={mockWorker} />);
	...
	describe("DiagOFTNetwork Component", () => {
		it("should display DiagOFT network configuration", async () => {
			const { DiagOFTNetwork } = await import("../assets/js/components/network/DiagOFTNetwork.jsx");
			...
			expect(() => render(<DiagOFTNetwork metadata={diagoftMetadata} filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
	});

	describe("BOFTNetwork Component", () => {
		it("should display BOFT network information", async () => {
			const { BOFTNetwork } = await import("../assets/js/components/network/BOFTNetwork.jsx");
			...
			expect(() => render(<BOFTNetwork metadata={boftMetadata} filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
	});

	describe("Network Component (Main)", () => {
		it("should render LoRA network type correctly", async () => {
			const { Network } = await import("../assets/js/components/network/Network.jsx");
			...
			render(<Network metadata={loraMetadata} filename="test.safetensors" worker={mockWorker} />);
		...
		it("should handle different network types", async () => {
			...
			expect(() => render(<Network metadata={lokrMetadata} filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
		...
		it("should handle unknown network types gracefully", async () => {
			...
			expect(() => render(<Network metadata={unknownMetadata} filename="test.safetensors" worker={mockWorker} />)).not.toThrow();
		});
	});
});
